...
const BookCard: React.FC<BookCardProps> = ({ description, cover, title, authorName, year, rate, show = "", id, genre, pages }) => {
  ...
  return (
        <div className='flex font-inter rounded-2xl w-fit p-5 flex-col max-w-137.5 shrink-0 input-shadow border border-white/20 hover:border-[#b99ef6] justify-center'>
