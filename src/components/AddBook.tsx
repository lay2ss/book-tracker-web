...
const AddBook = () => {
    ...
    <section className='h-screen w-full font-inter p-5 relative mx-auto text-white'>
        ...
        <div className="flex justify-center gap-10 mt-5 flex-wrap lg:flex-nowrap lg:justify-between">
            <div className="flex flex-col w-fit items-center lg:max-w-60  max-w-120">
                ...
                <div>
                    ...
                    <div className="flex flex-col lg:flex-row lg:gap-10 mt-2">
                        <div className="w-fit relative">
                            <div className={`bg-[#5453556c] p-5 w-30 ${checked? "absolute" : "hidden"}`}></div>
                            <div className={`bg-[#5453556c] p-5 w-20 right-0 ${checked? "absolute" : "hidden"}`}></div>
                            <DatePicker />  
                        </div>
