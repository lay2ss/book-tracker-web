      ...
      <main className="main-wrapper md:py-25">
        {loading? <Loading/> :
          <div>
            ...
            <div className={`z-10 ${showEdit? 'relative' : 'hidden'}`}>
              ...
              <div className="flex gap-2 pt-5 justify-end">
                ...
                <button onClick={() => setshowEdit(!showEdit)} className='h-min py-3 px-5 cursor-pointer addButton'>Cancel</button>
              </div>
              </div>
            </div>
            ...
            <div className="flex gap-4 flex-wrap mt-5">
              ...
              key={book.id} cover={book.coverImage}
              show="hidden"/>))}
            </div>
