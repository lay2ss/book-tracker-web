...
const HomePage = () => {
  return (
    <section className='flex h-screen w-full font-inter overflow-hidden flex-col p-5 relative mx-auto'>
        ...
        <main className='bg-white w-[90vw] md:w-[70vw] rounded-2xl gray-shadow mx-auto absolute -bottom-5 left-1/2 transform -translate-x-1/2 h-[92vh] gray-text'>
            <div className="p-5">
                <div className="relative w-full">
                    <input type="text" placeholder="Search for a book" className="border-none py-2 px-3 rounded-md outline-none focus:ring-1 focus:ring-[#FF6C00] bg-light-orange w-full"/>
            ...
            <div className="px-5">
                <div className="bg-light-orange flex py-4 px-5 justify-between rounded-md border border-[#FF6C00] flex-wrap text-sm">
            ...
            <div className="p-5 gray-text font-bold">
